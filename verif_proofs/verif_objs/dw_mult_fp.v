...
Module Info.
  ...
  Definition source_file := "dd_lib/dw_mult_fp.c".
...
Definition _dw_mult_fp9 : ident := $"dw_mult_fp9".
...
Definition f_dw_mult_fp9 := {|
  ...
  fn_temps := ((_c3, tdouble) :: (_t'1, tdouble) :: (_t'5, tdouble) ::
               (_t'4, tdouble) :: (_t'3, tdouble) :: (_t'2, tdouble) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _t'5
  ...
  (Ssequence
    (Ssequence
      (Ssequence
        ...
        (Ssequence
          (Sset _t'4 (Efield (Evar _ch (Tstruct _dword noattr)) _t tdouble))
          (Scall (Some _t'1)
            (Evar _fma (Tfunction
                         (Tcons tdouble (Tcons tdouble (Tcons tdouble Tnil)))
                         tdouble cc_default))
            ((Etempvar _t'3 tdouble) :: (Etempvar _y tdouble) ::
             (Etempvar _t'4 tdouble) :: nil))))
      (Sset _c3 (Etempvar _t'1 tdouble)))
    (Ssequence
      (Sset _t'2 (Efield (Evar _ch (Tstruct _dword noattr)) _s tdouble))
      (Scall None
        ...
        ((Etempvar _zh (tptr (Tstruct _dword noattr))) ::
         (Etempvar _t'2 tdouble) :: (Etempvar _c3 tdouble) :: nil)))))
|}.
...
((___compcert_va_int32,
 ...
 (_fast_2sum,
   Gfun(External (EF_external "fast_2sum"
     ...
     (Tcons (tptr (Tstruct _dword noattr))
       (Tcons tdouble (Tcons tdouble Tnil))) tvoid cc_default)) ::
 (_dw_mult_fp9, Gfun(Internal f_dw_mult_fp9)) :: nil).

Definition public_idents : list ident :=
(_dw_mult_fp9 :: _fast_2sum :: _fast_2mult :: _fma :: ___builtin_debug ::
