...
Module Info.
  ...
  Definition source_file := "dd_lib/TwoSum.c".
...
Definition f_TwoSum := {|
  ...
  fn_temps := ((_ap, tdouble) :: (_bp, tdouble) :: (_da, tdouble) ::
               (_db, tdouble) :: (_t'2, tdouble) :: (_t'1, tdouble) :: nil);
  fn_body :=
(Ssequence
  (Sassign
    (Efield
  ...
  (Ssequence
    ...
    (Ssequence
      ...
      (Ssequence
        (Sset _da
          (Ebinop Osub (Etempvar _a tdouble) (Etempvar _ap tdouble) tdouble))
        (Ssequence
          (Sset _db
            (Ebinop Osub (Etempvar _b tdouble) (Etempvar _bp tdouble)
              tdouble))
          (Sassign
            (Efield
              (Ederef (Etempvar _st (tptr (Tstruct __1017 noattr)))
                (Tstruct __1017 noattr)) _t tdouble)
...
((___compcert_va_int32,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_TwoSum, Gfun(Internal f_TwoSum)) :: nil).

Definition public_idents : list ident :=
(_TwoSum :: ___builtin_debug :: ___builtin_write32_reversed ::
